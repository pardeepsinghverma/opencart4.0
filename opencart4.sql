...
--
-- Table structure for table `ac_address_format`
--

CREATE TABLE `ac_address_format` (
...
--
-- Dumping data for table `ac_address_format`
--

INSERT INTO `ac_address_format` (`address_format_id`, `name`, `address_format`) VALUES
...
(1, 'Default', '', 1, '2023-05-22 21:08:58', '2023-05-22 21:08:58');
...
INSERT INTO `ac_category_description` (`category_id`, `language_id`, `name`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
INSERT INTO `ac_country` (`country_id`, `name`, `iso_code_2`, `iso_code_3`, `address_format_id`, `postcode_required`, `status`) VALUES
...
--
-- Table structure for table `ac_cron`
--

CREATE TABLE `ac_cron` (
...
--
-- Dumping data for table `ac_cron`
--

INSERT INTO `ac_cron` (`cron_id`, `code`, `description`, `cycle`, `action`, `status`, `date_added`, `date_modified`) VALUES
...
--
-- Table structure for table `ac_customer_affiliate_report`
--

CREATE TABLE `ac_customer_affiliate_report` (
...
--
-- Dumping data for table `ac_custom_field`
--

INSERT INTO `ac_custom_field` (`custom_field_id`, `type`, `value`, `validation`, `location`, `status`, `sort_order`) VALUES
...
--
-- Dumping data for table `ac_custom_field_customer_group`
--

INSERT INTO `ac_custom_field_customer_group` (`custom_field_id`, `customer_group_id`, `required`) VALUES
(1, 1, 1),
(2, 1, 1),
(3, 1, 1),
(4, 1, 1),
...
--
-- Dumping data for table `ac_custom_field_description`
--

INSERT INTO `ac_custom_field_description` (`custom_field_id`, `language_id`, `name`) VALUES
(1, 1, 'Select'),
(2, 1, 'Radio'),
(3, 1, 'Checkbox'),
(4, 1, 'Text'),
...
--
-- Dumping data for table `ac_custom_field_value`
--

INSERT INTO `ac_custom_field_value` (`custom_field_value_id`, `custom_field_id`, `sort_order`) VALUES
(1, 1, 1),
(2, 1, 2),
(3, 1, 3),
(4, 2, 1),
...
--
-- Dumping data for table `ac_custom_field_value_description`
--

INSERT INTO `ac_custom_field_value_description` (`custom_field_value_id`, `language_id`, `custom_field_id`, `name`) VALUES
(1, 1, 1, 'Test 1'),
(2, 1, 1, 'test 2'),
(3, 1, 1, 'Test 3'),
(4, 1, 2, 'Test 1'),
...
--
-- Table structure for table `ac_download_report`
--

CREATE TABLE `ac_download_report` (
...
INSERT INTO `ac_event` (`event_id`, `code`, `description`, `trigger`, `action`, `status`, `sort_order`) VALUES
...
INSERT INTO `ac_extension` (`extension_id`, `extension`, `type`, `code`) VALUES
...
INSERT INTO `ac_extension_install` (`extension_install_id`, `extension_id`, `extension_download_id`, `name`, `code`, `version`, `author`, `link`, `status`, `date_added`) VALUES
...
INSERT INTO `ac_extension_path` (`extension_path_id`, `extension_install_id`, `path`) VALUES
(1, 1, 'opencart'),
(2, 1, 'opencart/admin'),
...
--
-- Table structure for table `ac_gdpr`
--

CREATE TABLE `ac_gdpr` (
...
INSERT INTO `ac_information` (`information_id`, `bottom`, `sort_order`, `status`) VALUES
(1, 1, 3, 1),
(2, 1, 1, 1),
(3, 1, 4, 1),
(4, 1, 2, 1);
...
INSERT INTO `ac_information_description` (`information_id`, `language_id`, `title`, `description`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
(1, 1, 'About Us', '&lt;p&gt;\r\n	About Us&lt;/p&gt;\r\n', 'About Us', '', ''),
...
INSERT INTO `ac_language` (`language_id`, `name`, `code`, `locale`, `extension`, `sort_order`, `status`) VALUES
...
--
-- Table structure for table `ac_manufacturer_to_layout`
--

CREATE TABLE `ac_manufacturer_to_layout` (
  `manufacturer_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
  `layout_id` int(11) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Table structure for table `ac_marketing_report`
--

CREATE TABLE `ac_marketing_report` (
...
--
-- Table structure for table `ac_notification`
--

CREATE TABLE `ac_notification` (
...
--
-- Table structure for table `ac_order_subscription`
--

CREATE TABLE `ac_order_subscription` (
...
INSERT INTO `ac_product_description` (`product_id`, `language_id`, `name`, `description`, `tag`, `meta_title`, `meta_description`, `meta_keyword`) VALUES
...
--
-- Dumping data for table `ac_product_option`
--

INSERT INTO `ac_product_option` (`product_option_id`, `product_id`, `option_id`, `value`, `required`) VALUES
(208, 42, 4, 'test', 1),
(209, 42, 6, '', 1),
(217, 42, 5, '', 1),
(218, 42, 1, '', 1),
...
--
-- Dumping data for table `ac_product_option_value`
--

INSERT INTO `ac_product_option_value` (`product_option_value_id`, `product_option_id`, `product_id`, `option_id`, `option_value_id`, `quantity`, `subtract`, `price`, `price_prefix`, `points`, `points_prefix`, `weight`, `weight_prefix`) VALUES
...
--
-- Table structure for table `ac_product_report`
--

CREATE TABLE `ac_product_report` (
...
--
-- Dumping data for table `ac_product_reward`
--

INSERT INTO `ac_product_reward` (`product_reward_id`, `product_id`, `customer_group_id`, `points`) VALUES
(329, 43, 1, 600),
(331, 44, 1, 700),
(333, 45, 1, 800),
(335, 40, 1, 0),
...
--
-- Table structure for table `ac_product_subscription`
--

CREATE TABLE `ac_product_subscription` (
  `product_id` int(11) NOT NULL,
  `subscription_plan_id` int(11) NOT NULL,
  `customer_group_id` int(11) NOT NULL,
  `trial_price` decimal(10,4) NOT NULL,
...
--
-- Table structure for table `ac_product_viewed`
--

CREATE TABLE `ac_product_viewed` (
  `product_id` int(11) NOT NULL,
...
INSERT INTO `ac_seo_url` (`seo_url_id`, `store_id`, `language_id`, `key`, `value`, `keyword`, `sort_order`) VALUES
...
(96, 0, 'config', 'config_email', 'pv74596@gmail.com', 0),
...
(210, 0, 'config', 'config_encryption', '', 0),
(211, 0, 'config', 'config_api_id', '1', 0);

-- --------------------------------------------------------

--
-- Table structure for table `ac_startup`
--

CREATE TABLE `ac_startup` (
...
--
-- Table structure for table `ac_subscription`
--

CREATE TABLE `ac_subscription` (
  `subscription_id` int(11) NOT NULL,
  `order_id` int(11) NOT NULL,
  `order_product_id` int(11) NOT NULL,
  `store_id` int(11) NOT NULL,
...
--
-- Table structure for table `ac_subscription_history`
--

CREATE TABLE `ac_subscription_history` (
...
--
-- Table structure for table `ac_subscription_plan`
--

CREATE TABLE `ac_subscription_plan` (
  `subscription_plan_id` int(11) NOT NULL,
  `trial_price` decimal(10,4) NOT NULL,
  `trial_frequency` enum('day','week','semi_month','month','year') NOT NULL,
...
--
-- Dumping data for table `ac_subscription_plan`
--

INSERT INTO `ac_subscription_plan` (`subscription_plan_id`, `trial_price`, `trial_frequency`, `trial_duration`, `trial_cycle`, `trial_status`, `frequency`, `duration`, `cycle`, `status`, `sort_order`) VALUES
...
--
-- Table structure for table `ac_subscription_plan_description`
--

CREATE TABLE `ac_subscription_plan_description` (
  `subscription_plan_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(255) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `ac_subscription_plan_description`
--

INSERT INTO `ac_subscription_plan_description` (`subscription_plan_id`, `language_id`, `name`) VALUES
...
--
-- Table structure for table `ac_subscription_status`
--

CREATE TABLE `ac_subscription_status` (
  `subscription_status_id` int(11) NOT NULL,
  `language_id` int(11) NOT NULL,
  `name` varchar(32) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci ROW_FORMAT=DYNAMIC;
...
--
-- Dumping data for table `ac_subscription_status`
--

INSERT INTO `ac_subscription_status` (`subscription_status_id`, `language_id`, `name`) VALUES
(1, 1, 'Pending'),
(2, 1, 'Active'),
(3, 1, 'Expired'),
(4, 1, 'Suspended'),
...
(1, 1, 'admin', '$2y$10$KxDI3d5WknhX1hGnjlyFGePe/PGUJ90tVm37IQoSFfnRY2n6kg7mO', 'John', 'Doe', 'pv74596@gmail.com', '', '', '', 1, '2023-05-22 21:08:58');
...
--
-- Table structure for table `ac_user_login`
--
...
--
-- Indexes for table `ac_address_format`
--
ALTER TABLE `ac_address_format`
...
--
-- Indexes for table `ac_customer_affiliate_report`
--
ALTER TABLE `ac_customer_affiliate_report`
...
--
-- Indexes for table `ac_download_report`
--
ALTER TABLE `ac_download_report`
...
--
-- Indexes for table `ac_manufacturer_to_layout`
--
ALTER TABLE `ac_manufacturer_to_layout`
...
--
-- Indexes for table `ac_marketing_report`
--
ALTER TABLE `ac_marketing_report`
...
--
-- Indexes for table `ac_notification`
--
ALTER TABLE `ac_notification`
...
--
-- Indexes for table `ac_order_subscription`
--
ALTER TABLE `ac_order_subscription`
...
--
-- Indexes for table `ac_product_report`
--
ALTER TABLE `ac_product_report`
...
--
-- Indexes for table `ac_product_subscription`
--
ALTER TABLE `ac_product_subscription`
...
--
-- Indexes for table `ac_product_viewed`
--
ALTER TABLE `ac_product_viewed`
  ADD PRIMARY KEY (`product_id`);
...
--
-- Indexes for table `ac_startup`
--
ALTER TABLE `ac_startup`
...
--
-- Indexes for table `ac_subscription`
--
ALTER TABLE `ac_subscription`
  ADD PRIMARY KEY (`subscription_id`),
  ADD KEY `order_id` (`order_id`);

--
-- Indexes for table `ac_subscription_history`
--
ALTER TABLE `ac_subscription_history`
  ADD PRIMARY KEY (`subscription_history_id`);

--
-- Indexes for table `ac_subscription_plan`
--
ALTER TABLE `ac_subscription_plan`
  ADD PRIMARY KEY (`subscription_plan_id`);

--
-- Indexes for table `ac_subscription_plan_description`
--
ALTER TABLE `ac_subscription_plan_description`
  ADD PRIMARY KEY (`subscription_plan_id`,`language_id`);

--
-- Indexes for table `ac_subscription_status`
--
ALTER TABLE `ac_subscription_status`
...
--
-- Indexes for table `ac_user_authorize`
--
ALTER TABLE `ac_user_authorize`
...
--
-- Indexes for table `ac_user_login`
--
ALTER TABLE `ac_user_login`
...
--
-- AUTO_INCREMENT for table `ac_address_format`
--
ALTER TABLE `ac_address_format`
...
--
-- AUTO_INCREMENT for table `ac_attribute`
--
ALTER TABLE `ac_attribute`
  MODIFY `attribute_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `ac_attribute_group`
--
ALTER TABLE `ac_attribute_group`
...
--
-- AUTO_INCREMENT for table `ac_cron`
--
ALTER TABLE `ac_cron`
...
--
-- AUTO_INCREMENT for table `ac_customer_activity`
--
ALTER TABLE `ac_customer_activity`
  MODIFY `customer_activity_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_affiliate_report`
--
ALTER TABLE `ac_customer_affiliate_report`
  MODIFY `customer_affiliate_report_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_approval`
--
ALTER TABLE `ac_customer_approval`
  MODIFY `customer_approval_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_group`
--
ALTER TABLE `ac_customer_group`
  MODIFY `customer_group_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `ac_customer_history`
--
ALTER TABLE `ac_customer_history`
  MODIFY `customer_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_ip`
--
ALTER TABLE `ac_customer_ip`
  MODIFY `customer_ip_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_login`
--
ALTER TABLE `ac_customer_login`
  MODIFY `customer_login_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_reward`
--
ALTER TABLE `ac_customer_reward`
  MODIFY `customer_reward_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_search`
--
ALTER TABLE `ac_customer_search`
  MODIFY `customer_search_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_customer_transaction`
--
ALTER TABLE `ac_customer_transaction`
  MODIFY `customer_transaction_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_custom_field`
--
ALTER TABLE `ac_custom_field`
  MODIFY `custom_field_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=29;

--
-- AUTO_INCREMENT for table `ac_custom_field_value`
--
ALTER TABLE `ac_custom_field_value`
...
--
-- AUTO_INCREMENT for table `ac_download_report`
--
ALTER TABLE `ac_download_report`
...
--
-- AUTO_INCREMENT for table `ac_gdpr`
--
ALTER TABLE `ac_gdpr`
...
--
-- AUTO_INCREMENT for table `ac_marketing_report`
--
ALTER TABLE `ac_marketing_report`
...
--
-- AUTO_INCREMENT for table `ac_notification`
--
ALTER TABLE `ac_notification`
...
--
-- AUTO_INCREMENT for table `ac_order_subscription`
--
ALTER TABLE `ac_order_subscription`
...
--
-- AUTO_INCREMENT for table `ac_product_report`
--
ALTER TABLE `ac_product_report`
...
--
-- AUTO_INCREMENT for table `ac_startup`
--
ALTER TABLE `ac_startup`
...
--
-- AUTO_INCREMENT for table `ac_subscription`
--
ALTER TABLE `ac_subscription`
  MODIFY `subscription_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_subscription_history`
--
ALTER TABLE `ac_subscription_history`
  MODIFY `subscription_history_id` int(11) NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `ac_subscription_plan`
--
ALTER TABLE `ac_subscription_plan`
  MODIFY `subscription_plan_id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `ac_subscription_status`
--
ALTER TABLE `ac_subscription_status`
...
--
-- AUTO_INCREMENT for table `ac_user_authorize`
--
ALTER TABLE `ac_user_authorize`
...
--
-- AUTO_INCREMENT for table `ac_user_login`
--
ALTER TABLE `ac_user_login`
